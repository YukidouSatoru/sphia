...
SphiaConfig _$SphiaConfigFromJson(Map<String, dynamic> json) => SphiaConfig(
      ...
      showTransport: json['showTransport'] as bool,
      ...
      updateSubscriptionInterval: json['updateSubscriptionInterval'] as int,
