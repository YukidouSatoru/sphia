...
SphiaConfig _$SphiaConfigFromJson(Map<String, dynamic> json) => SphiaConfig(
      ...
      routingProvider: json['routingProvider'] as String,
      vmessProvider: json['vmessProvider'] as String,
      vlessProvider: json['vlessProvider'] as String,
      shadowsocksProvider: json['shadowsocksProvider'] as String,
      trojanProvider: json['trojanProvider'] as String,
      hysteriaProvider: json['hysteriaProvider'] as String,
      additionalSocksPort: json['additionalSocksPort'] as int,
      tunProvider: json['tunProvider'] as String,
